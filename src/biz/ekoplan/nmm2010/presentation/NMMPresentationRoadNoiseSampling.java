 ...
 * @author Jarek
 */
public class NMMPresentationRoadNoiseSampling implements Printable, NMMPresentation, Serializable {
    ...
    public NMMPresentationRoadNoiseSampling(NMMProject _nmmProj, long _stTime, long _endTime, 
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (sem.getLDWN()>0) {
            g2d.drawString(NMMToolbox.formatDouble(sem.getLDWN())+"±"+NMMToolbox.formatDouble(sem.getURAB95_dwn())
                +"dB", metricColumnOffset+110, 295f);
        } else {
        ...
        if (sem.getLN()>0) {
            g2d.drawString(NMMToolbox.formatDouble(sem.getLD())+"±"+NMMToolbox.formatDouble(sem.getURAB95_dwn_d())
                +"dB", metricColumnOffset+245, 295f);
        } else {
            g2d.drawString(java.util.ResourceBundle.getBundle("biz/ekoplan/nmm2010/languages/translations").getString("NIE_DOTYCZY"), metricColumnOffset+245, 295f);
        }
        ...
        if (sem.getLW()>0) {
            g2d.drawString(NMMToolbox.formatDouble(sem.getLN())+"±"+NMMToolbox.formatDouble(sem.getURAB95_dwn_w())
                +"dB", metricColumnOffset+245, 310f);
        } else {
        ...
        if (sem.getLN()>0) {
            g2d.drawString(NMMToolbox.formatDouble(sem.getLN())+"±"+NMMToolbox.formatDouble(sem.getURAB95_dwn_n())
