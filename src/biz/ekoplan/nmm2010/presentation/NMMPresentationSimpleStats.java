 ...
 * @author Jarek
 */
public class NMMPresentationSimpleStats implements Printable, NMMPresentation, Serializable {
    ...
    public NMMPresentationSimpleStats(NMMProject _nmmProj, 
        ...
        this.noiseSourceModel=_noiseSourceModel;
        this.locale=_loc;
    }
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2d.drawString("Współrzędne: X="+NMMToolbox.formatDouble(this.nmmProj
                .getCurrentMeasurement().getCoordinateX(), "#0.0000")+" Y="+
                NMMToolbox.formatDouble(this.nmmProj
                .getCurrentMeasurement().getCoordinateY(), "#0.0000")
                +" h="+NMMToolbox.formatDouble(
                this.nmmProj.getCurrentMeasurement().getHeight()),65, 678);
        ...
        g2d.setFont(new Font(Font.SERIF, 1, 10));
        g2d.setColor(Color.BLUE);
        g2d.drawString("Histogram", 340f, 500);
        g2d.setColor(Color.BLACK);
        g2d.setFont(new Font(Font.SERIF, 1, 6));
        NMMHistogramPainter hp = new NMMHistogramPainter(g2d,nmmProj,pageFormat, this.startTime, 
                this.endTime, 1,360, 50, 520, 220, this.noiseSourceModel, this.locale);
        
        
        // krzywa skumulowana
        g2d.setFont(new Font(Font.SERIF, 1, 10));
        g2d.setColor(Color.BLUE);
        g2d.drawString("Krzywa skumulowana", 340f, 665);
        g2d.setColor(Color.BLACK);
        g2d.setFont(new Font(Font.SERIF, 1, 6));
        NMMCumulativeCurvePainter cc = new NMMCumulativeCurvePainter(g2d,nmmProj,pageFormat, this.startTime, 
                this.endTime, 1,360, 50, 675, 80, this.noiseSourceModel, true, false, this.locale);
    ...
    public PresentationType getPresentationType() {
        return PresentationType.SIMPLE_STATS_PRESENTATION;
    }
