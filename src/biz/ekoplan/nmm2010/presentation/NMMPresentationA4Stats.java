 ...
 * @author Jarek
 */
public class NMMPresentationA4Stats implements Printable, NMMPresentation, Serializable {
    ...
    public NMMPresentationA4Stats(NMMProject _nmmProj, 
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2d.setStroke(stroke);
        g2d.drawLine((int)pageFormat.getImageableX()+50,
                (int)pageFormat.getImageableHeight()-330,
                (int)pageFormat.getImageableWidth()-20,
                (int)pageFormat.getImageableHeight()-330);
        ...
        g2d.drawString("Histogram", 60f, 246);
        ...
        NMMHistogramPainter hp = new NMMHistogramPainter(g2d,nmmProj,pageFormat, this.startTime, 
                this.endTime, 1,120, 40, 260, 370, this.noiseSourceModel, this.locale);
                
        // krzywa skumulowana
        g2d.setFont(new Font(Font.SERIF, 1, 10));
        g2d.setColor(Color.BLUE);
        g2d.drawString("Krzywa skumulowana", 60f, 530);
        g2d.setColor(Color.BLACK);
        g2d.setFont(new Font(Font.SERIF, 1, 6));
        NMMCumulativeCurvePainter cc = new NMMCumulativeCurvePainter(g2d,nmmProj,pageFormat, this.startTime, 
                this.endTime, 1,120, 40, 540, 80, this.noiseSourceModel, true, false, this.locale);
    ...
    public PresentationType getPresentationType() {
        return PresentationType.A4_STATS_PRESENTATON;
    }
