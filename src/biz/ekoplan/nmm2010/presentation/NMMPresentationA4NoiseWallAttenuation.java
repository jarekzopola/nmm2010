 ...
 * @author Jarek
 */
public class NMMPresentationA4NoiseWallAttenuation implements Printable, NMMPresentation, Serializable {
    ...
    public NMMPresentationA4NoiseWallAttenuation(NMMProject _nmmProj, 
