 ...
 * @author Jarek
 */
public class NMMPresentationMegaKarta0 implements Printable, NMMPresentation, Serializable {
    ...
    public NMMPresentationMegaKarta0(NMMProject _nmmProj, long _stTime, long _endTime, Setup _setup, NMMNoiseSourceModel _nsm, Locale _locale) {
        nmmProj=_nmmProj;
...
//        }                
        ...
        g2d.drawString("Noise Measurement Manager (c)2007-2013 Ekoprojekt http://www.ekoprojekt.biz/", 65,
                (int)pageFormat.getImageableHeight()-7);
        try {
             img = ImageIO.read(new File("ecoplan.png"));
