 ...
 * @author jarek
 */
public class NMMMainChartBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( nmm2010.NMMMainChart.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_NMMProject = 71;
    private static final int PROPERTY_numberOfRecordsInViewport = 72;
    ...
    private static final int PROPERTY_pixNumberOnDataRecord = 79;
    private static final int PROPERTY_preferredSize = 80;
    private static final int PROPERTY_preferredSizeSet = 81;
    private static final int PROPERTY_projectWideRecordTime = 82;
    ...
    private static final int PROPERTY_timeSelector = 89;
    ...
    private static final int PROPERTY_veticalScale = 99;
    private static final int PROPERTY_vetoableChangeListeners = 100;
    private static final int PROPERTY_viewportBottomMargin = 101;
    private static final int PROPERTY_viewportEndTime = 102;
    private static final int PROPERTY_viewportHeight = 103;
    private static final int PROPERTY_viewPortPercentRange = 104;
    private static final int PROPERTY_viewportStartTime = 105;
    private static final int PROPERTY_viewportTopMargin = 106;
    ...
    private static final int PROPERTY_XCoordStringTime = 111;
    private static final int PROPERTY_XCoordTime = 112;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", nmm2010.NMMMainChart.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", nmm2010.NMMMainChart.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", nmm2010.NMMMainChart.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", nmm2010.NMMMainChart.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", nmm2010.NMMMainChart.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", nmm2010.NMMMainChart.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", nmm2010.NMMMainChart.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", nmm2010.NMMMainChart.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", nmm2010.NMMMainChart.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", nmm2010.NMMMainChart.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", nmm2010.NMMMainChart.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", nmm2010.NMMMainChart.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", nmm2010.NMMMainChart.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", nmm2010.NMMMainChart.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", nmm2010.NMMMainChart.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", nmm2010.NMMMainChart.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", nmm2010.NMMMainChart.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", nmm2010.NMMMainChart.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", nmm2010.NMMMainChart.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", nmm2010.NMMMainChart.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", nmm2010.NMMMainChart.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", nmm2010.NMMMainChart.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", nmm2010.NMMMainChart.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", nmm2010.NMMMainChart.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", nmm2010.NMMMainChart.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", nmm2010.NMMMainChart.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", nmm2010.NMMMainChart.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", nmm2010.NMMMainChart.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", nmm2010.NMMMainChart.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", nmm2010.NMMMainChart.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", nmm2010.NMMMainChart.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", nmm2010.NMMMainChart.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", nmm2010.NMMMainChart.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", nmm2010.NMMMainChart.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", nmm2010.NMMMainChart.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", nmm2010.NMMMainChart.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", nmm2010.NMMMainChart.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", nmm2010.NMMMainChart.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", nmm2010.NMMMainChart.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", nmm2010.NMMMainChart.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", nmm2010.NMMMainChart.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", nmm2010.NMMMainChart.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", nmm2010.NMMMainChart.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", nmm2010.NMMMainChart.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", nmm2010.NMMMainChart.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", nmm2010.NMMMainChart.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", nmm2010.NMMMainChart.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", nmm2010.NMMMainChart.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", nmm2010.NMMMainChart.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", nmm2010.NMMMainChart.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", nmm2010.NMMMainChart.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", nmm2010.NMMMainChart.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", nmm2010.NMMMainChart.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", nmm2010.NMMMainChart.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", nmm2010.NMMMainChart.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", nmm2010.NMMMainChart.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", nmm2010.NMMMainChart.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", nmm2010.NMMMainChart.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", nmm2010.NMMMainChart.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", nmm2010.NMMMainChart.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", nmm2010.NMMMainChart.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", nmm2010.NMMMainChart.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", nmm2010.NMMMainChart.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", nmm2010.NMMMainChart.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", nmm2010.NMMMainChart.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", nmm2010.NMMMainChart.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", nmm2010.NMMMainChart.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", nmm2010.NMMMainChart.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", nmm2010.NMMMainChart.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", nmm2010.NMMMainChart.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", nmm2010.NMMMainChart.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_NMMProject] = new PropertyDescriptor ( "NMMProject", nmm2010.NMMMainChart.class, null, "setNMMProject" ); // NOI18N
            properties[PROPERTY_numberOfRecordsInViewport] = new PropertyDescriptor ( "numberOfRecordsInViewport", nmm2010.NMMMainChart.class, "getNumberOfRecordsInViewport", null ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", nmm2010.NMMMainChart.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", nmm2010.NMMMainChart.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", nmm2010.NMMMainChart.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", nmm2010.NMMMainChart.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", nmm2010.NMMMainChart.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", nmm2010.NMMMainChart.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_pixNumberOnDataRecord] = new PropertyDescriptor ( "pixNumberOnDataRecord", nmm2010.NMMMainChart.class, "getPixNumberOnDataRecord", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", nmm2010.NMMMainChart.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", nmm2010.NMMMainChart.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_projectWideRecordTime] = new IndexedPropertyDescriptor ( "projectWideRecordTime", nmm2010.NMMMainChart.class, null, null, "getProjectWideRecordTime", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", nmm2010.NMMMainChart.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", nmm2010.NMMMainChart.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", nmm2010.NMMMainChart.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", nmm2010.NMMMainChart.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", nmm2010.NMMMainChart.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", nmm2010.NMMMainChart.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_timeSelector] = new PropertyDescriptor ( "timeSelector", nmm2010.NMMMainChart.class, null, "setTimeSelector" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", nmm2010.NMMMainChart.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", nmm2010.NMMMainChart.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", nmm2010.NMMMainChart.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", nmm2010.NMMMainChart.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", nmm2010.NMMMainChart.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", nmm2010.NMMMainChart.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", nmm2010.NMMMainChart.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", nmm2010.NMMMainChart.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", nmm2010.NMMMainChart.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_veticalScale] = new IndexedPropertyDescriptor ( "veticalScale", nmm2010.NMMMainChart.class, null, null, null, "setVeticalScale" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", nmm2010.NMMMainChart.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_viewportBottomMargin] = new PropertyDescriptor ( "viewportBottomMargin", nmm2010.NMMMainChart.class, "getViewportBottomMargin", null ); // NOI18N
            properties[PROPERTY_viewportEndTime] = new PropertyDescriptor ( "viewportEndTime", nmm2010.NMMMainChart.class, "getViewportEndTime", null ); // NOI18N
            properties[PROPERTY_viewportHeight] = new PropertyDescriptor ( "viewportHeight", nmm2010.NMMMainChart.class, "getViewportHeight", null ); // NOI18N
            properties[PROPERTY_viewPortPercentRange] = new PropertyDescriptor ( "viewPortPercentRange", nmm2010.NMMMainChart.class, null, "setViewPortPercentRange" ); // NOI18N
            properties[PROPERTY_viewportStartTime] = new PropertyDescriptor ( "viewportStartTime", nmm2010.NMMMainChart.class, "getViewportStartTime", null ); // NOI18N
            properties[PROPERTY_viewportTopMargin] = new PropertyDescriptor ( "viewportTopMargin", nmm2010.NMMMainChart.class, "getViewportTopMargin", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", nmm2010.NMMMainChart.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", nmm2010.NMMMainChart.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", nmm2010.NMMMainChart.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", nmm2010.NMMMainChart.class, "getX", null ); // NOI18N
            properties[PROPERTY_XCoordStringTime] = new IndexedPropertyDescriptor ( "XCoordStringTime", nmm2010.NMMMainChart.class, null, null, "getXCoordStringTime", null ); // NOI18N
            properties[PROPERTY_XCoordTime] = new IndexedPropertyDescriptor ( "XCoordTime", nmm2010.NMMMainChart.class, null, null, "getXCoordTime", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", nmm2010.NMMMainChart.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( nmm2010.NMMMainChart.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_setViewPortTimeRange132 = 132;
    ...
    private static final int METHOD_zoomOut146 = 146;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_paintComponent94] = new MethodDescriptor(nmm2010.NMMMainChart.class.getMethod("paintComponent", new Class[] {java.awt.Graphics.class})); // NOI18N
            ...
            methods[METHOD_setViewPortTimeRange132] = new MethodDescriptor(nmm2010.NMMMainChart.class.getMethod("setViewPortTimeRange", new Class[] {long.class, long.class})); // NOI18N
            methods[METHOD_setViewPortTimeRange132].setDisplayName ( "" );
            ...
            methods[METHOD_update143] = new MethodDescriptor(nmm2010.NMMMainChart.class.getMethod("update", new Class[] {java.util.Observable.class, java.lang.Object.class})); // NOI18N
            ...
            methods[METHOD_zoomOut146] = new MethodDescriptor(nmm2010.NMMMainChart.class.getMethod("zoomOut", new Class[] {})); // NOI18N
            methods[METHOD_zoomOut146].setDisplayName ( "" );
        }
